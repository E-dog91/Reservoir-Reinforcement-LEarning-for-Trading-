...
class Model_lstm_ridge(Base_model_rc_ridge):
    def __init__(self, input_dim, hidden_dim, output_dim,
        ...
        self.rec_cell = nn.LSTM(input_size=self._input_dim, hidden_size=self._hidden_dim, batch_first=True)
        ...
        # the lstm cells needs 4 matrices for each the in_matrix, in_bias, recurrent_matrix and recurrent_bias
    ...
    def _hidden_state_init(self, batch_size):
        ...
        c0 = self._h0_Generator(**self._h0_params).generate(size=(1, batch_size, self._hidden_dim), dtype=self.dtype)
        return h0, c0
